...
# Infrarojo
    ("infrarojo", 0, Pins("H2"), IOStandard("LVCMOS33")),
    ("infrarojo", 1, Pins("G2"), IOStandard("LVCMOS33")),
    ("infrarojo", 2, Pins("E7"), IOStandard("LVCMOS33")),
    ("infrarojo", 3, Pins("J3"), IOStandard("LVCMOS33")),
    ("infrarojo", 4, Pins("J4"), IOStandard("LVCMOS33")),#
    ("infrarojo", 5, Pins("G4"), IOStandard("LVCMOS33")),
    
#teclado    
    ("Fila",  3, Pins("G6"), IOStandard("LVCMOS33")),
    ("Fila",  2, Pins("J2"), IOStandard("LVCMOS33")),
    ("Fila",  1, Pins("F6"), IOStandard("LVCMOS33")),
    ("Fila",  0, Pins("K1"), IOStandard("LVCMOS33")),
    ("Columna",  3, Pins("G3"), IOStandard("LVCMOS33")),
    ("Columna",  2, Pins("G1"), IOStandard("LVCMOS33")),
    ("Columna",  1, Pins("H1"), IOStandard("LVCMOS33")),
    ("Columna",  0, Pins("H4"), IOStandard("LVCMOS33")),

    # Movimiento
    ("left", 0, Pins("D17"), IOStandard("LVCMOS33")),
    ("left", 1, Pins("E17"), IOStandard("LVCMOS33")),
    ("right", 0, Pins("F18"), IOStandard("LVCMOS33")),
    ("right", 1, Pins("G18"), IOStandard("LVCMOS33")),
