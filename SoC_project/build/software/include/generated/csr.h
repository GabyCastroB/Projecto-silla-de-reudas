...
/* switchs */
#define CSR_SWITCHS_BASE (CSR_BASE + 0x0L)
#define CSR_SWITCHS_IN_ADDR (CSR_BASE + 0x0L)
...
/* display */
#define CSR_DISPLAY_BASE (CSR_BASE + 0x1000L)
#define CSR_DISPLAY_SEL_ADDR (CSR_BASE + 0x1000L)
...
#define CSR_DISPLAY_VALUE_ADDR (CSR_BASE + 0x1004L)
...
#define CSR_DISPLAY_WRITE_ADDR (CSR_BASE + 0x1008L)
...
/* infrarojo_cntrl */
#define CSR_INFRAROJO_CNTRL_BASE (CSR_BASE + 0x1800L)
#define CSR_INFRAROJO_CNTRL_IN_ADDR (CSR_BASE + 0x1800L)
#define CSR_INFRAROJO_CNTRL_IN_SIZE 1
static inline uint32_t infrarojo_cntrl_in_read(void) {
	return csr_read_simple((CSR_BASE + 0x1800L));
}

/* Top_teclado */
#define CSR_TOP_TECLADO_BASE (CSR_BASE + 0x2000L)
#define CSR_TOP_TECLADO_ASCII_ADDR (CSR_BASE + 0x2000L)
#define CSR_TOP_TECLADO_ASCII_SIZE 1
static inline uint32_t Top_teclado_ascii_read(void) {
	return csr_read_simple((CSR_BASE + 0x2000L));
}
#define CSR_TOP_TECLADO_ISDONE_ADDR (CSR_BASE + 0x2004L)
#define CSR_TOP_TECLADO_ISDONE_SIZE 1
static inline uint32_t Top_teclado_isDone_read(void) {
	return csr_read_simple((CSR_BASE + 0x2004L));
}

/* movimiento_cntrl */
#define CSR_MOVIMIENTO_CNTRL_BASE (CSR_BASE + 0x2800L)
#define CSR_MOVIMIENTO_CNTRL_ESTADO_ADDR (CSR_BASE + 0x2800L)
