...
module top (
	...
	input  wire infrarojo0,
	input  wire infrarojo1,
	input  wire infrarojo2,
	input  wire infrarojo3,
	input  wire infrarojo4,
	input  wire infrarojo5,
	output wire Fila0,
	output wire Fila1,
	output wire Fila2,
	output wire Fila3,
...
reg  [5:0] cs2 = 6'd1;
wire [5:0] infrarojo_cntrl_status;
wire infrarojo_cntrl_we;
reg  infrarojo_cntrl_re = 1'd0;
wire [6:0] ascii_status;
wire ascii_we;
reg  ascii_re = 1'd0;
wire isDone_status;
wire isDone_we;
...
reg  csrbank0_ascii_re = 1'd0;
wire [6:0] csrbank0_ascii_r;
reg  csrbank0_ascii_we = 1'd0;
wire [6:0] csrbank0_ascii_w;
reg  csrbank0_isDone_re = 1'd0;
wire csrbank0_isDone_r;
reg  csrbank0_isDone_we = 1'd0;
wire csrbank0_isDone_w;
wire csrbank0_sel;
...
reg  csrbank3_sel0_re = 1'd0;
wire [3:0] csrbank3_sel0_r;
reg  csrbank3_sel0_we = 1'd0;
wire [3:0] csrbank3_sel0_w;
reg  csrbank3_value0_re = 1'd0;
wire [3:0] csrbank3_value0_r;
reg  csrbank3_value0_we = 1'd0;
...
wire [5:0] csrbank4_in_r;
reg  csrbank4_in_we = 1'd0;
wire [5:0] csrbank4_in_w;
wire csrbank4_sel;
wire [13:0] interface5_bank_bus_adr;
wire interface5_bank_bus_we;
wire [31:0] interface5_bank_bus_dat_w;
reg  [31:0] interface5_bank_bus_dat_r = 32'd0;
reg  csrbank5_estado0_re = 1'd0;
wire [2:0] csrbank5_estado0_r;
reg  csrbank5_estado0_we = 1'd0;
wire [2:0] csrbank5_estado0_w;
wire csrbank5_sel;
...
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *) reg  [5:0] xilinxmultiregimpl3_regs0 = 6'd0;
(* async_reg = "true", dont_touch = "true" *) reg  [5:0] xilinxmultiregimpl3_regs1 = 6'd0;
...
assign csrbank0_ascii_r = interface0_bank_bus_dat_w[6:0];
always @(*) begin
	csrbank0_ascii_we <= 1'd0;
	csrbank0_ascii_re <= 1'd0;
	if ((csrbank0_sel & (interface0_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank0_ascii_re <= interface0_bank_bus_we;
		csrbank0_ascii_we <= (~interface0_bank_bus_we);
	end
end
assign csrbank0_isDone_r = interface0_bank_bus_dat_w[0];
always @(*) begin
	csrbank0_isDone_we <= 1'd0;
	csrbank0_isDone_re <= 1'd0;
	if ((csrbank0_sel & (interface0_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank0_isDone_re <= interface0_bank_bus_we;
		csrbank0_isDone_we <= (~interface0_bank_bus_we);
	end
end
assign csrbank0_ascii_w = ascii_status[6:0];
assign ascii_we = csrbank0_ascii_we;
assign csrbank0_isDone_w = isDone_status;
assign isDone_we = csrbank0_isDone_we;
...
always @(*) begin
	csrbank3_sel0_re <= 1'd0;
	csrbank3_sel0_we <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank3_sel0_re <= interface3_bank_bus_we;
		csrbank3_sel0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_value0_r = interface3_bank_bus_dat_w[3:0];
always @(*) begin
	csrbank3_value0_we <= 1'd0;
	csrbank3_value0_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank3_value0_re <= interface3_bank_bus_we;
		csrbank3_value0_we <= (~interface3_bank_bus_we);
	end
end
assign write_r = interface3_bank_bus_dat_w[0];
always @(*) begin
	write_we <= 1'd0;
	write_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 2'd2))) begin
		write_re <= interface3_bank_bus_we;
		write_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_sel0_w = sel_storage[3:0];
assign csrbank3_value0_w = value_storage[3:0];
assign csrbank4_sel = (interface4_bank_bus_adr[13:9] == 2'd3);
assign csrbank4_in_r = interface4_bank_bus_dat_w[5:0];
always @(*) begin
	csrbank4_in_re <= 1'd0;
	csrbank4_in_we <= 1'd0;
...
assign csrbank4_in_w = infrarojo_cntrl_status[5:0];
assign infrarojo_cntrl_we = csrbank4_in_we;
assign csrbank5_sel = (interface5_bank_bus_adr[13:9] == 3'd5);
assign csrbank5_estado0_r = interface5_bank_bus_dat_w[2:0];
always @(*) begin
	csrbank5_estado0_re <= 1'd0;
	csrbank5_estado0_we <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank5_estado0_re <= interface5_bank_bus_we;
		csrbank5_estado0_we <= (~interface5_bank_bus_we);
	end
end
assign csrbank5_estado0_w = movimiento_cntrl_storage[2:0];
...
assign infrarojo_cntrl_status = xilinxmultiregimpl3_regs1;
assign xilinxmultiregimpl3 = {infrarojo5, infrarojo4, infrarojo3, infrarojo2, infrarojo1, infrarojo0};
...
always @(posedge sys_clk) begin
	...
	if (csrbank0_sel) begin
		case (interface0_bank_bus_adr[8:0])
			1'd0: begin
				interface0_bank_bus_dat_r <= csrbank0_ascii_w;
			end
			1'd1: begin
				interface0_bank_bus_dat_r <= csrbank0_isDone_w;
			end
		endcase
	end
	ascii_re <= csrbank0_ascii_re;
	isDone_re <= csrbank0_isDone_re;
	...
	if (csrbank3_sel) begin
		case (interface3_bank_bus_adr[8:0])
			...
			2'd2: begin
				interface3_bank_bus_dat_r <= write_w;
			end
		endcase
	end
	if (csrbank3_sel0_re) begin
		sel_storage[3:0] <= csrbank3_sel0_r;
	end
	sel_re <= csrbank3_sel0_re;
	if (csrbank3_value0_re) begin
		value_storage[3:0] <= csrbank3_value0_r;
	end
	value_re <= csrbank3_value0_re;
	...
	infrarojo_cntrl_re <= csrbank4_in_re;
	interface5_bank_bus_dat_r <= 1'd0;
	if (csrbank5_sel) begin
		case (interface5_bank_bus_adr[8:0])
			1'd0: begin
				interface5_bank_bus_dat_r <= csrbank5_estado0_w;
			end
		endcase
	end
	if (csrbank5_estado0_re) begin
		movimiento_cntrl_storage[2:0] <= csrbank5_estado0_r;
	end
	movimiento_cntrl_re <= csrbank5_estado0_re;
	...
	xilinxmultiregimpl3_regs0 <= {infrarojo5, infrarojo4, infrarojo3, infrarojo2, infrarojo1, infrarojo0};
...
//------------------------------------------------------------------------------
// Memory rom: 5773-words x 32-bit
//------------------------------------------------------------------------------
...
Top_teclado Top_teclado(
	.Columna({Columna3, Columna2, Columna1, Columna0}),
	.clk50(sys_clk),
	.Fila({Fila3, Fila2, Fila1, Fila0}),
	.ascii(ascii_status),
	.isDone(isDone_status)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-11-24 10:52:41.
//------------------------------------------------------------------------------
